...
using Tonestro.Prism.Plugin.Mopups.Dialogs.Xaml;
...
public class PopupDialogService : IDialogService
{
    ...
    {
        var view = (View)ContainerProvider.Resolve<object>(name);
        return view;
    }
    ...
    private IDialogResult CloseDialog(IDialogParameters parameters, PopupPage popupPage, View dialogView)
    {
        try
        {
            ...
            PopupNavigation.RemovePageAsync(popupPage, animated);
        ...
        bool animated = true)
    {
        ...
        await PopupNavigation.PushAsync(popupPage, animated);
    }
